...
CREATE TABLE KidsChurch.Parent_Child (
    ...
    CONSTRAINT FK_Parent_Child_User FOREIGN KEY (User_ID) REFERENCES KidsChurch.[User](User_ID),
    CONSTRAINT FK_Parent_Child_Child FOREIGN KEY (Child_ID) REFERENCES KidsChurch.Child(Child_ID)
);
...
CREATE TABLE KidsChurch.Teacher_Class (
    ...
    CONSTRAINT FK_Teacher_Class_User FOREIGN KEY (User_ID) REFERENCES KidsChurch.[User](User_ID),
    CONSTRAINT FK_Teacher_Class_Class FOREIGN KEY (Class_ID) REFERENCES KidsChurch.Class(Class_ID)
);

-- Administrator table
CREATE TABLE KidsChurch.Administrator (
    ...
    CONSTRAINT FK_Administrator_User FOREIGN KEY (User_ID) REFERENCES KidsChurch.[User](User_ID)
);
...
CREATE TABLE KidsChurch.Check_In_Out (
    ...
    CONSTRAINT FK_Check_Child FOREIGN KEY (Child_ID) REFERENCES KidsChurch.Child(Child_ID),
    CONSTRAINT FK_Check_Parent FOREIGN KEY (Parent_User_ID) REFERENCES KidsChurch.[User](User_ID),
    CONSTRAINT FK_Check_Class FOREIGN KEY (Class_ID) REFERENCES KidsChurch.Class(Class_ID),
    CONSTRAINT FK_Check_Security FOREIGN KEY (Security_User_ID) REFERENCES KidsChurch.[User](User_ID)
);

-- QR_Code table
CREATE TABLE KidsChurch.QR_Code (
    ...
    CONSTRAINT FK_QR_Child FOREIGN KEY (Child_ID) REFERENCES KidsChurch.Child(Child_ID),
    CONSTRAINT FK_QR_Check_In FOREIGN KEY (Check_In_ID) REFERENCES KidsChurch.Check_In_Out(Check_ID)
);
